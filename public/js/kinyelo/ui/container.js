 ...
 * @inheritDoc
 */
kinyelo.ui.Container.prototype.addChildAt = function(control, index, opt_render) {
...
kinyelo.ui.Container.prototype.getChild = function(id) {
    return goog.ui.Container.superClass_.getChild.call(this, id);
}