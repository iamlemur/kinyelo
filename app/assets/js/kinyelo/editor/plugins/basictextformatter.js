...
goog.provide('kinyelo.editor.plugins.BasicTextFormatter');
goog.provide('kinyelo.editor.plugins.BasicTextFormatter.COMMAND');
 ...
 */
kinyelo.editor.plugins.BasicTextFormatter = function() {
    goog.editor.Plugin.call(this);
};
goog.inherits(kinyelo.editor.plugins.BasicTextFormatter, goog.editor.Plugin);


/** @override */
kinyelo.editor.plugins.BasicTextFormatter.prototype.getTrogClassId = function() {
    return 'BTF';
};
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.logger =
    goog.debug.Logger.getLogger('kinyelo.editor.plugins.BasicTextFormatter');
 ...
 * @enum {string}
 */
kinyelo.editor.plugins.BasicTextFormatter.COMMAND = {
    LINK: '+link',
 ...
 * {@link kinyelo.editor.plugins.BasicTextFormatter.COMMAND} constants. Used to
 * determine whether a string corresponds to a command this plugin
 * handles in O(1) time.
 * @type {Object}
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.SUPPORTED_COMMANDS_ =
    goog.object.transpose(kinyelo.editor.plugins.BasicTextFormatter.COMMAND);
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.isSupportedCommand = function(
    command) {
    // TODO(user): restore this to simple check once table editing
    // is moved out into its own plugin
    return command in kinyelo.editor.plugins.BasicTextFormatter.SUPPORTED_COMMANDS_;
};
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.getRange_ = function() {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.getDocument_ = function() {
 ...
 *     the kinyelo.editor.plugins.BasicTextFormatter.BLOCK_COMMAND.
 *     It will be unused for other commands.
 * @return {Object|undefined} The result of the command.
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.execCommandInternal = function(
    command, var_args) {
    ...
    switch (command) {
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BACKGROUND_COLOR:
        ...
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.LINK:
            result = this.toggleLink_(opt_arg);
            break;

        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.JUSTIFY_CENTER:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.JUSTIFY_FULL:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.JUSTIFY_RIGHT:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.JUSTIFY_LEFT:
        ...
        default:
            if (goog.userAgent.IE &&
                command ==
                    kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FORMAT_BLOCK &&
                opt_arg) {
            ...
            if (command ==
                kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_COLOR &&
                goog.isNull(opt_arg)) {
            ...
            switch (command) {
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.INDENT:
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.OUTDENT:
                    if (goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS) {
                        ...
                        if (goog.userAgent.OPERA) {
                            if (command ==
                                kinyelo.editor.plugins.BasicTextFormatter.COMMAND.OUTDENT) {
                ...
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ORDERED_LIST:
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.UNORDERED_LIST:
                ...
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FORMAT_BLOCK:
                ...
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUBSCRIPT:
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUPERSCRIPT:
                ...
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.UNDERLINE:
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BOLD:
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ITALIC:
                ...
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_COLOR:
                case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_FACE:
             ...
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.STRIKE_THROUGH:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.HORIZONTAL_RULE:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUBSCRIPT:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUPERSCRIPT:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.UNDERLINE:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BOLD:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ITALIC:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_SIZE:
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_FACE:
             */
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.focusField_ = function() {
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.queryCommandValue = function(
    command) {
    var styleWithCss;
    switch (command) {
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.LINK:
        ...
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FORMAT_BLOCK:
            ...
            return kinyelo.editor.plugins.BasicTextFormatter.getSelectionBlockState_(
                this.getFieldObject().getRange());

        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.INDENT:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.OUTDENT:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.HORIZONTAL_RULE:
            // TODO: See if there are reasonable results to return for
            // these commands.
            return false;

        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_SIZE:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_FACE:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.FONT_COLOR:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BACKGROUND_COLOR:
        ...
        default:
             ...
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BOLD
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ITALIC
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ORDERED_LIST
             * kinyelo.editor.plugins.BasicTextFormatter.COMMAND.UNORDERED_LIST
             */
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.prepareContentsHtml =
    function(html) {
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.cleanContentsDom =
    function(fieldCopy) {
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.cleanContentsHtml =
    function(html) {
 ...
 * @override
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.handleKeyboardShortcut =
    function(e, key, isModifierPressed) {
        ...
        switch (key) {
            case 'b': // Ctrl+B
                command = kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BOLD;
                break;
            case 'i': // Ctrl+I
                command = kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ITALIC;
                break;
            case 'u': // Ctrl+U
                command = kinyelo.editor.plugins.BasicTextFormatter.COMMAND.UNDERLINE;
                break;
            case 's': // Ctrl+S
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.BR_REGEXP_ =
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.convertBreaksToDivs_ =
    function() {
        ...
        kinyelo.editor.plugins.BasicTextFormatter.BR_REGEXP_.lastIndex = 0;
        // Only mess with the HTML/selection if it contains a BR.
        if (kinyelo.editor.plugins.BasicTextFormatter.BR_REGEXP_.test(
            parent.innerHTML)) {
            ...
            if (parent.tagName == goog.dom.TagName.P) {
                ...
                kinyelo.editor.plugins.BasicTextFormatter.convertParagraphToDiv_(
                    parent, true);
            } else {
                // Used to do:
...
/**
 * If this is a kinyelo.editor.plugins.BasicTextFormatter.COMMAND,
 ...
 *
 * @param {kinyelo.editor.plugins.BasicTextFormatter.COMMAND|string}
 *     command A command key.
 * @return {string} The equivalent execCommand command.
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.convertToRealExecCommand_ = function(
    command) {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.justify_ = function(command) {
    ...
    if (!(goog.editor.BrowserFeature.HAS_STYLE_WITH_CSS &&
        ...
        goog.iter.forEach(this.getFieldObject().getRange(),
            kinyelo.editor.plugins.BasicTextFormatter.convertContainerToTextAlign_);
    }
};
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.inlineFormatFix_ = function(command, is_pre) {
    var oldTag = null;
    var newTag = null;
    switch(command) {
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ITALIC:
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.execCommandHelper_ = function(
    ...
    command = kinyelo.editor.plugins.BasicTextFormatter.convertToRealExecCommand_(
        command);
    ...
    switch(origCommand) {
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.BOLD:
        case kinyelo.editor.plugins.BasicTextFormatter.COMMAND.ITALIC:
            this.inlineFormatFix_(origCommand, false);
            break;
    }
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.applyBgColorManually_ =
    function(bgColor) {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.toggleLink_ = function(
    opt_target) {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.createLink_ = function(range,
                                                                        url, opt_target) {
    var anchor = null;
    var anchors = [];
    var parent = range && range.getContainerElement();
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.brokenExecCommandsIE_ = {
    'indent' : 1,
    'outdent' : 1,
    'insertOrderedList' : 1,
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.blockquoteHatingCommandsIE_ = {
    'insertOrderedList' : 1,
    'insertUnorderedList' : 1
};
 ...
 * @param {kinyelo.editor.plugins.BasicTextFormatter.COMMAND} command The command
 *     being applied, either SUBSCRIPT or SUPERSCRIPT.
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.
    ...
    if (!this.queryCommandValue(command)) {
        ...
        var oppositeCommand =
            (command == kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUBSCRIPT ?
                kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUPERSCRIPT :
                kinyelo.editor.plugins.BasicTextFormatter.COMMAND.SUBSCRIPT);
        var oppositeExecCommand = kinyelo.editor.plugins.BasicTextFormatter.
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.removeFontSizeFromStyleAttrs_ =
    function() {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.applyExecCommandIEFixes_ =
    function(command) {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.cleanUpSafariHeadings_ =
    function() {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.fixSafariLists_ = function() {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.orderedListTypes_ = {
    '1' : 1,
    'a' : 1,
    'A' : 1,
    'i' : 1,
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.unorderedListTypes_ = {
    'disc' : 1,
    'circle' : 1,
    'square' : 1
};
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.fixIELists_ = function() {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.brokenExecCommandsSafari_ = {
    'justifyCenter' : 1,
    'justifyFull' : 1,
    'justifyRight': 1,
    'justifyLeft': 1,
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.hangingExecCommandWebkit_ = {
    'insertOrderedList': 1,
    'insertUnorderedList': 1
};
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.applyExecCommandSafariFixes_ =
    function(command) {
        // See the comment on brokenExecCommandsSafari_
        var div;
        if (kinyelo.editor.plugins.BasicTextFormatter.
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.applyExecCommandGeckoFixes_ =
    function(command) {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.invalidateInlineCss_ =
    function() {
        var ancestors = [];
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.beforeInsertListGecko_ =
    function() {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.getSelectionBlockState_ =
    function(range) {
        var tagName = null;
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.SUPPORTED_JUSTIFICATIONS_ = {
    'center': 1,
    'justify': 1,
    'right': 1,
    'left': 1
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.isJustification_ =
    function(command) {
        ...
        if (bidiPlugin) {
            ...
            for (var i = 0; i < nodes.length; i++) {
                ...
                var container = goog.editor.style.getContainer(
                    /** @type {Node} */ (current));
                if (alignment !=
                    kinyelo.editor.plugins.BasicTextFormatter.getNodeJustification_(
                        container)) {
                    return false;
                }
            }
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.isNodeInState_ =
    function(nodeName) {
        var range = this.getRange_();
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.queryCommandStateInternal_ =
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.queryCommandValueInternal_ =
    function(queryObject, command, opt_styleWithCss) {
 ...
 * @private
 */
kinyelo.editor.plugins.BasicTextFormatter.prototype.queryCommandHelper_ = function(
    isGetQueryCommandState, queryObject, command, opt_styleWithCss) {
    command =
        kinyelo.editor.plugins.BasicTextFormatter.convertToRealExecCommand_(
            command);
    if (opt_styleWithCss) {
        var doc = this.getDocument_();
